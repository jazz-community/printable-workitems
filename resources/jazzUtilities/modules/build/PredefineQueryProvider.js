define(['dojo/_base/declare', "com.ibm.team.dashboard.web.ui.DashboardConstants", 'com.ibm.team.workitem.viewlets.web.ui.internal.utils.WorkItemQueryChooser'], function (declare) {
  ...
  return declare("com.siemens.bt.jazz.viewlet.printableworkitems.jazzUtilities.modules.build.PredefineQueryProvider", dojo.global.com.ibm.team.dashboard.web.ui.CustomPreferenceProvider, {
    ...
    getLabel: function getLabel(value) {
      return this.context.predefineQuery === undefined || this.context.predefineQuery === null || this.context.predefineQuery === "" ? 'No Query Predefined' : "Query: ".concat(JSON.parse(this.context.predefineQuery).name);
    },
